...
|------|-------------|------|---------|:--------:|
| <a name="input_create"></a> [create](#input\_create) | If true, remove affinity | <pre>object({<br>    install        = optional(bool, false)<br>    kubeconfig_raw = optional(string, "")<br>  })</pre> | `{}` | no |
