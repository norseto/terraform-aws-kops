...
| <a name="input_ebs_csi_driver"></a> [ebs\_csi\_driver](#input\_ebs\_csi\_driver) | EBS-CSI-Driver configuration | <pre>object({<br>    # Use EBS-CSI-Driver<br>    enabled = optional(bool, true)<br>    # Self Managed EBS-CSI-Driver(Only setup IRSA)<br>    self_managed = optional(bool, false)<br>  })</pre> | `{}` | no |
